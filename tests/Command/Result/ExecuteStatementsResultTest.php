...
final class ExecuteStatementsResultTest extends TestCase
{
    /**
     * @covers \Shareforce\Neo4j\Command\Result\ExecuteStatementsResult::fromResponse
    ...
    public function testCommitUrlIsPopulated(): void
    {
        ...
        // Act
        $result = ExecuteStatementsResult::fromResponse($data);
