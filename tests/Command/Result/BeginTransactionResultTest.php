...
final class BeginTransactionResultTest extends TestCase
{
    /**
     * @covers \Shareforce\Neo4j\Command\Result\BeginTransactionResult::fromResponse
    ...
    public function testCommitUrlIsPopulated(): void
    {
        ...
        // Act
        $result = BeginTransactionResult::fromResponse($data);
